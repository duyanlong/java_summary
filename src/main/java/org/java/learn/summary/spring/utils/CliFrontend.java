...
// */
//
//package org.java.learn.summary.spring.utils;
//
//import static org.apache.flink.util.Preconditions.checkNotNull;
//import static org.java.learn.summary.spring.utils.CliFrontendParser.HELP_OPTION;
//
//import java.io.File;
...
//    }
//
//    private PackagedProgram getPackagedProgram(ProgramOptions programOptions)
...
//        Comparator<Entry<JobStatus, List<JobStatusMessage>>> statusComparator =
...
//    // }
//
//    public CommandLine getCommandLine(final Options commandOptions, final String[] args, final boolean stopAtNonOptions)
...
//     */
//    private <ClusterID> void runClusterAction(CustomCommandLine activeCommandLine, CommandLine commandLine,
//        ClusterAction<ClusterID> clusterAction) throws FlinkException {
//        final Configuration executorConfig = activeCommandLine.applyCommandLineOptionsToConfiguration(commandLine);
//        final ClusterClientFactory<ClusterID> clusterClientFactory = clusterClientServiceLoader
...
//                    System.out
//                        .println(commitID.equals(EnvironmentInformation.UNKNOWN) ? "" : ", Commit ID: " + commitID);
//                    return 0;
//                default:
...
//
//        String[] newArr = new String[args.length + 4];
//        newArr[0] = "run";
//        newArr[1] = "-d";
//        newArr[2] = "-m";
//        newArr[3] = "10.160.121.155:30700";
//
//        for (int idx = 0; idx < args.length; idx++) {
//            newArr[idx + 4] = args[idx];
//        }
//        try {
//            testSubmitJob(newArr);
//            System.out.println("jobserver submitted the job successfully");
//            return true;
//        } catch (Exception exp) {
//            exp.printStackTrace();
//            return false;
...
//    }
//
//    public static void testSubmitJob(String[] args) {
//        EnvironmentInformation.logEnvironmentInfo(LOG, "Command Line Client", args);
//
//        // run -d -m 10.160.121.155:30700 D://WordCount.jar
//        // 1. find the configuration directory
//        // TODO duyanlong 改成固定值暂时注释
//        // final String configurationDirectory = getConfigurationDirectoryFromEnv();
//        final String configurationDirectory = "D:\\flink-1.7.2\\conf";
//
